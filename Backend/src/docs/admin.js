 ...
 * tags:
 *   name: Admin
 *   description: Admin-only endpoints (requires Bearer token with role=admin)
 */
 ...
 *               description: { type: string, example: Button broken on mobile }
 ...
 * /api/admin/stats:
 *   get:
 *     summary: Get dashboard stats (total users, tasks by status, etc.)
 *     tags: [Admin]
 *     security:
 *       - bearerAuth: []
 *     responses:
